...
public class SQLTools {
     ...
     * @param id novel的id
     */
    public static void setStartTime(String id, SQLiteNovel sqLiteNovel, Context context) {
        Cursor cursor = sqLiteNovel.getReadableDatabase().query("novel", new String[]{"start"}, "id=? and start != 0",
                new String[]{String.valueOf(id)}, null, null, null);
        if (!cursor.moveToNext()) {
            new SharedTools(context).increaseStart();
            ContentValues values = new ContentValues();
     ...
     * @param id novel的id
     */
    public static void setFinishTime(String id, SQLiteNovel sqLiteNovel, Context context) {
        ...
        if (cursor.moveToNext() && cursor.getInt(1) == 1) {
            new SharedTools(context).increaseFinish();
            ContentValues values = new ContentValues();
    ...
    public static void delete(SQLiteNovel sqLiteNovel, String novel_id, NovelService service, Context context) {
        ...
        String table = "FL" + NovelTools.md5(name + author);
